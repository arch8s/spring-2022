[> Home](../README.md)   [> Problem Background](README.md) > Architecture Analysis
...
The possible market expansion adds a second functional requirement - internationalizability. We could already add Spanish and Chinese localizations to grow our audience since they are among the top used languages in the US.
